	...
	public:
		...
		*/
		...
		void showListMovie(){
			...
			cout<<setw(4) <<setfill(' ') <<(i+1) <<" " <<Con.getlistmovie().getMovieName(i) <<endl;
			}
		}
		
		void showSummaryAndDetail(string moviename){
			...
			cout << setw(10) <<setfill(' ') <<left << "Total Chair : " <<setw(8) <<setfill(' ') <<Con.cal(moviename)/150 << endl;
			cout << setw(10) <<setfill(' ') <<left << "Unit Price  : " <<setw(8) <<setfill(' ') <<"150" << setw(5) <<setfill(' ') <<left << "Bath" <<endl;
			cout << setw(10) <<setfill(' ') <<left << "Net income  : " <<setw(8) <<setfill(' ') << Con.cal(moviename) << setw(5) <<setfill(' ') <<left << "Bath"<<endl;
			cout << "================================================================" <<endl;
